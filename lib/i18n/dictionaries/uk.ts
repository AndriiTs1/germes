...
export const uk: Dictionary = {
  ...
  settings: {
    ...
    support: {
      ...
      createTicket: "Створити звернення",
      myTickets: "Мої звернення",
      contactDescription: "Зв’язатися з командою підтримки Germes",
      historyDescription: "Історія ваших звернень",
      createError: "Не вдалося створити звернення. Спробуйте ще раз.",
      messageError: "Не вдалося надіслати повідомлення. Спробуйте ще раз.",
      ticketUnavailable: "Це звернення недоступне.",
      ticketClosed: "Це звернення закрито.",
      pageSubtitle: "Ваші звернення та листування з підтримкою Germes.",
      backToSettings: "Назад до налаштувань",
      newRequest: "Нове звернення",
      emptyTitle: "Звернень поки немає",
      emptyDescription: "Після звернення до підтримки Germes воно з’явиться тут.",
      updated: "Оновлено",
      messages: "повідомлень",
      newTitle: "Створити звернення",
      newSubtitle: "Опишіть проблему або запитання, і команда підтримки Germes його розгляне.",
      subject: "Тема",
      subjectPlaceholder: "Коротко опишіть, з чим потрібна допомога",
      category: "Категорія",
      message: "Повідомлення",
      messagePlaceholder: "Опишіть проблему, очікуваний результат і що сталося.",
      sendRequest: "Надіслати звернення",
      sending: "Надсилання...",
      backToRequests: "Назад до звернень",
      ticketNumber: "Звернення",
      conversation: "Листування",
      reply: "Відповідь",
      replyPlaceholder: "Напишіть відповідь команді підтримки Germes...",
      sendMessage: "Надіслати повідомлення",
      closedNotice: "Звернення закрито. Нові повідомлення додати не можна.",
      categories: {
        bug: "Помилка",
        question: "Запитання",
        featureRequest: "Пропозиція функції",
        account: "Обліковий запис",
        other: "Інше",
      },
      statuses: {
        new: "Нове",
        inProgress: "У роботі",
        waitingCustomer: "Очікує вашої відповіді",
        resolved: "Вирішено",
        closed: "Закрито",
      },
    },
