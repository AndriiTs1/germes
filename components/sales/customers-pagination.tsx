...
function buildPageHref(page: number, status: CustomersStatusFilter, q: string, manager?: string): string {
...
export function CustomersPagination({ page, pageCount, q, status, manager, dictionary }: CustomersPaginationProps) {
