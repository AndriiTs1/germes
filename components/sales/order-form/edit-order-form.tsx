...
import type { SalesOrderForEdit } from "@/lib/services/sales/get-sales-order-for-edit";
import {
 ...
 * plain text <input> in this form (Customer/Requested date are button-based
 * Select/DateInput triggers) — a real text-entry control, so it needs the
 * same iOS Safari auto-zoom prevention already applied to Qty/Price in
 * order-form-item-row.tsx.
 */
