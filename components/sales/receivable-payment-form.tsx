...
import {
  ...
  type RegisterPaymentActionState,
} from "@/app/sales/orders/[id]/finance-actions";
import { Button } from "@/components/ui/button";
import { Input } from "@/components/ui/input";
import type { Dictionary } from "@/lib/i18n/get-dictionary";
import { cn } from "@/lib/utils";

const INITIAL_STATE: RegisterPaymentActionState = {
  ok: false,
  message: null,
};
...
export function ReceivablePaymentForm({
  ...
  currency: string;
  dictionary: Dictionary["orderDetail"]["receivable"];
}) {
    ...
    >
      ...
      <div className="grid gap-2 sm:grid-cols-[1fr_auto]">
        <Input
          ...
          autoCapitalize="off"
          spellCheck={false}
          placeholder={dictionary.paymentAmountPlaceholder.replace("{currency}", currency)}
          disabled={pending}
