...
function buildFilterHref(status: CustomersStatusFilter, q: string, manager?: string): string {
 ...
 */
export function CustomersFilters({ q, status, manager, dictionary }: CustomersFiltersProps) {
